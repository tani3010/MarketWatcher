...
class GoldenCross(BaseStrategy):
    def __init__(self, broker, data, params):
        self.GlodenCross_timeperiod_short = 5
        self.GoldenCross_timeperiod_long = 25
        self.set_optimization_parameter(
            GlodenCross_timeperiod_short=range(5, 25, 5),
    ...
    def init(self):
        super().init()
        self.ma_short = self.metrics.SMA(self.data, self.df_freq, self.GlodenCross_timeperiod_short)
